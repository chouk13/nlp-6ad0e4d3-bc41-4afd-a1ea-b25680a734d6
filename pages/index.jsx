...
const PROJECT_NAME = "6ad0e4d3-bc41-4afd-a1ea-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DancePic\nPromesse principale : Transforme ta photo en vidéo IA où tu danses sur la dernière tendance TikTok en quelques secondes.\nPain point principal : Difficile et chronophage de créer des vidéos tendances originales à partir de photos statiques pour buzzer sur TikTok et Reels.\nFonctionnalités clés :\n- Conversion instantanée de photo en avatar dansant sur un trend TikTok viral\n- Bibl";
